  ...
  gruntTaskUtils = {
    ...
    beautifier : {
      ...
      addReplacements : function (replacements) {
        ...
        gruntTasksUtils.beautifier.replacements = gruntTasksUtils.beautifier.replacements.concat(replacements);
      },
      ...
      onBeautified: function (content, args) {
        ...
        var replacements = gruntTasksUtils.beautifier.replacements || [];
        ...
        Object.keys(counts).forEach(function (key) {
          ...
          var entry = counts[key],
            ...
            regex = entry.regex;
          if (count > 0) {
            var msg = lib.format('Replacing {0} with {1}, {2} time(s)', regex, key, count);
          }
        });
